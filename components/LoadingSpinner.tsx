...
const LoadingSpinner: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center p-8 bg-white rounded-2xl shadow-lg max-w-md mx-auto">
      ...
      <h2 className="text-xl font-semibold text-slate-700 mt-6">Gerando seu relatório...</h2>
      <p className="text-slate-500 mt-2 transition-opacity duration-500">{loadingMessages[messageIndex]}</p>
    </div>
  );
};
